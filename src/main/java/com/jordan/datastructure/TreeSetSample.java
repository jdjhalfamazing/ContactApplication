...
public class TreeSetSample {
        ...
        public static void main(String[] args) {
            ...
            // print the items in first set - order is not guaranteed but sorted
            ...
            names.addAll(names2);
            System.out.println("Added The Second Set Back To The First Set : " + names);
            ...
            System.out.println("First Name In TreeSet: " + names.first());
            System.out.println("Last Name In TreeSet: " + names.last());


            // before removing element
            System.out.println("Before removing first element from" +
                    " TreeSet with pollFirst: " + names);
            ...
            // before removing element
            System.out.println("Before removing last element from" +
                    " TreeSet with pollLast: " + names);

            // first element is removed
            System.out.println("First last element removed is : "
                    + names.pollLast());
