    ...
    public static void main(String[] args) {
     ...
     //   int average;
        ...
        for (int i = 0; i < numOfGrades; i++ ){
            System.out.println("Now can you enter your score");
            int eachGrade = grade.nextInt();
            scores.add(eachGrade);
            if (eachGrade > largestNumber){
                 largestNumber = eachGrade;
            }
        ...
        System.out.println(largestNumber + " is the highest score");
